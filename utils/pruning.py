...
def prune_media_paths(media_paths: list[set], dir_to_keep: str = ""):
    """
...
def prune_media_directories(
    ...
    """
    Checks directories for duplicates and removes all media pahs except for the one specified
    in directory_to_keep. Defaults to first directory in list.
